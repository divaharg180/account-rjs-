...
const Layout = () => {
  return (
    <div>
    <h1 id="email">adharshvidhyalaya@gmail.com           <img  src={emailLogo} id="png" />
</h1> <h2 id="phone"><img  src={phoneLogo} id="png" />04256-256216,316,516 </h2>
    ...
    <span id="span2">EDUCATIONAL INSTITUTIONS</span></h4>
      ...
      <div className="topbar"> 
        <ul>
          ...
          <li>
            <Link id="bar" to="/students">Institutions</Link>
          </li>
          <li>
